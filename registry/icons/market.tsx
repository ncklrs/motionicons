...
const Market = React.forwardRef<SVGSVGElement, LivelyIconProps>(
  (
    {
      size,
      strokeWidth,
    ...
    return (
      <motion.svg
        ...
        {...props}
      >
        <motion.path d="M3 21V8l9-5 9 5v13" {...(isDraw ? pathAnimationProps : {})} pathLength={1} className={isDraw ? 'draw-path' : ''}/>
