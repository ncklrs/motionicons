...
const LampFloor = React.forwardRef<SVGSVGElement, LivelyIconProps>(
  (
    {
      size,
      strokeWidth,
    ...
    return (
      <motion.svg
        ...
        {...props}
      >
        <motion.path d="M9 2h6l3 7H6l3-7Z" {...(isDraw ? pathAnimationProps : {})} pathLength={1} className={isDraw ? 'draw-path' : ''}/>
