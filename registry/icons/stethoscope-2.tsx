...
const Stethoscope2 = React.forwardRef<SVGSVGElement, LivelyIconProps>(
  (
    {
      size,
      strokeWidth,
    ...
    return (
      ...
      <motion.path d="M8 15v1a6 6 0 0 0 6 6v0a3 3 0 0 0 3-3v-2" {...(isDraw ? pathAnimationProps : {})} pathLength={1} className={isDraw ? 'draw-path' : ''}/>
...
Stethoscope2.displayName = "Stethoscope2";
