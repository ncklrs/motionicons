...
const Dividend = React.forwardRef<SVGSVGElement, LivelyIconProps>(
  (
    {
      size,
      strokeWidth,
    ...
    return (
      ...
      <motion.path d="M15 9h-4.5a2 2 0 0 0 0 4h3a2 2 0 0 1 0 4H9" {...(isDraw ? pathAnimationProps : {})} pathLength={1} className={isDraw ? 'draw-path' : ''}/>
      </motion.svg>
    );
  }
);
