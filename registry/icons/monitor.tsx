...
const Monitor = React.forwardRef<SVGSVGElement, LivelyIconProps>(
  (
    {
      size,
      strokeWidth,
    ...
    return (
      <motion.svg
        ...
        {...props}
      >
        <motion.rect width="20" height="14" x="2" y="3" rx="2" {...(isDraw ? pathAnimationProps : {})}  pathLength={1} className={isDraw ? 'draw-path' : ''}/>
