...
const Subtask = React.forwardRef<SVGSVGElement, LivelyIconProps>(
  (
    {
      size,
      strokeWidth,
    ...
    return (
      ...
      <motion.path d="M10 12v5a2 2 0 0 0 2 2h9" {...(isDraw ? pathAnimationProps : {})} pathLength={1} className={isDraw ? 'draw-path' : ''}/>
