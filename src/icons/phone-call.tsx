...
export const PhoneCall = ({
  ...
  return (
    ...
    >
      ...
      <motion.path d="M14.05 2a9 9 0 0 1 8 7.94" {...(isDraw ? pathAnimationProps : {})}  pathLength={1} className={isDraw ? 'draw-path' : ''}/>
      <motion.path d="M14.05 6A5 5 0 0 1 18 10" {...(isDraw ? pathAnimationProps : {})}  pathLength={1} className={isDraw ? 'draw-path' : ''}/>
    </motion.svg>
  )
}
