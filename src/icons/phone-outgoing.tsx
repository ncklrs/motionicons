...
export const PhoneOutgoing = ({
  ...
  return (
    ...
    >
      <motion.polyline points="22 8 22 2 16 2" {...(isDraw ? pathAnimationProps : {})}  pathLength={1} className={isDraw ? 'draw-path' : ''}/>
      <motion.line x1="16" x2="22" y1="8" y2="2" {...(isDraw ? pathAnimationProps : {})}  pathLength={1} className={isDraw ? 'draw-path' : ''}/>
