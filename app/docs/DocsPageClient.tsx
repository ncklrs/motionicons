      ...
      <div className="pt-16 flex overflow-hidden">
        ...
        <main className="flex-1 lg:ml-64 w-full max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 min-w-0">
          ...
          <section id="nextjs-app-router" className="mb-16 scroll-mt-24">
            <h2 className="font-display text-2xl font-bold text-bone mb-6 flex items-center gap-3">
              <span className="w-8 h-8 bg-graphite flex items-center justify-center text-sm text-electric">12</span>
              Next.js App Router
            </h2>
            <p className="text-silver mb-6">
              LivelyIcons provides multiple approaches for Next.js App Router with React Server Components (RSC).
              Choose the right approach based on your needs.
            </p>

            {/* Import Paths Reference Table */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4">Import Paths Quick Reference</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-graphite">
                      <th className="text-left py-3 px-4 text-silver font-medium">Approach</th>
                      <th className="text-left py-3 px-4 text-silver font-medium">Import Path</th>
                      <th className="text-left py-3 px-4 text-silver font-medium hidden sm:table-cell">Use Case</th>
                      <th className="text-center py-3 px-4 text-silver font-medium">Client JS</th>
                    </tr>
                  </thead>
                  <tbody className="text-ghost">
                    <tr className="border-b border-graphite/50">
                      ...
                      <td className="py-3 px-4"><code className="text-electric">livelyicons</code></td>
                      <td className="py-3 px-4 hidden sm:table-cell text-silver">Interactive UI, hover effects</td>
                      <td className="py-3 px-4 text-center"><Check size={16} className="text-electric mx-auto" /></td>
                    </tr>
                    <tr className="border-b border-graphite/50">
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4"><code className="text-electric">livelyicons/static</code></td>
                      <td className="py-3 px-4 hidden sm:table-cell text-silver">Server layouts, navigation</td>
                      <td className="py-3 px-4 text-center"><X size={16} className="text-steel mx-auto" /></td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4"><code className="text-electric">livelyicons/css</code></td>
                      <td className="py-3 px-4 hidden sm:table-cell text-silver">Server + CSS animations</td>
                      <td className="py-3 px-4 text-center"><X size={16} className="text-steel mx-auto" /></td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="mt-4 grid sm:grid-cols-3 gap-4">
                <div className="bg-carbon border border-graphite p-4">
                  ...
                  <p className="text-xs text-silver">
                    Full Motion animations. Requires <code className="text-electric">&apos;use client&apos;</code> directive.
                  </p>
                </div>
                <div className="bg-carbon border border-graphite p-4">
                  <div className="flex items-center gap-2 mb-2">
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">1</span>
                Server Component with Static Icons
              </h3>
              <div className="bg-carbon border border-graphite p-4 mb-4">
                <p className="text-sm text-silver">
                  <strong className="text-bone">Best for:</strong> Navigation, headers, footers, and any server-rendered UI.
                  Zero client-side JavaScript - icons render as pure SVG on the server.
                </p>
              </div>
              <CodeBlock code={rscStaticLayoutCode} section="rsc-static-layout" />
            </div>

            {/* Pattern 2: Client Boundary */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">2</span>
                Client Component Boundary
              </h3>
              <div className="bg-carbon border border-graphite p-4 mb-4">
                <p className="text-sm text-silver">
                  <strong className="text-bone">Best for:</strong> Interactive icons that need hover effects, state changes, or Motion animations.
                  Create a small client component wrapper for interactive icons.
                </p>
              </div>
              <CodeBlock code={rscClientBoundaryCode} section="rsc-client-boundary" />
            </div>

            {/* Pattern 3: CSS Animation */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">3</span>
                CSS Animation Alternative
              </h3>
              <div className="bg-carbon border border-graphite p-4 mb-4">
                <p className="text-sm text-silver">
                  <strong className="text-bone">Best for:</strong> When you need animations but want to avoid client JavaScript entirely.
                  Use CSS classes with static icons for RSC-safe animations.
                </p>
              </div>
              <CodeBlock code={rscCssAnimationCode} section="rsc-css-animation" />

              <div className="mt-6">
                <h4 className="text-sm font-semibold text-bone mb-3">Available CSS Animation Classes</h4>
                <div className="flex flex-wrap gap-2">
                  {['motionicon-scale', 'motionicon-rotate', 'motionicon-pulse', 'motionicon-bounce', 'motionicon-shake', 'motionicon-spin', 'motionicon-draw'].map((cls) => (
                    <code key={cls} className="text-xs bg-carbon border border-graphite px-2 py-1 text-electric">{cls}</code>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">4</span>
                Hybrid Pattern (Static Layout + Animated Content)
              </h3>
              <div className="bg-carbon border border-graphite p-4 mb-4">
                <p className="text-sm text-silver">
                  <strong className="text-bone">Best for:</strong> Real-world apps that need both fast server rendering and interactive elements.
                  Use static icons in layouts, animated icons in specific client components.
                </p>
              </div>
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">5</span>
                Lazy Loading with Suspense Fallback
              </h3>
              <div className="bg-carbon border border-graphite p-4 mb-4">
                <p className="text-sm text-silver">
                  <strong className="text-bone">Best for:</strong> Progressive enhancement where animated icons load after initial render.
                  Use static icons as Suspense fallbacks for seamless loading states.
                </p>
              </div>
              <CodeBlock code={rscSuspenseFallbackCode} section="rsc-suspense" />
            </div>

            {/* Decision Guide */}
            <div className="bg-carbon border border-graphite p-6">
              <h4 className="font-display font-semibold text-bone mb-4">Which Approach Should I Use?</h4>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-electric mt-0.5 shrink-0" />
                  <div>
                    <p className="text-sm text-bone font-semibold">Use <code className="text-electric">livelyicons/static</code> when:</p>
                    <p className="text-xs text-silver mt-1">You want zero client JS, need SSR/SSG, or icons are purely decorative.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-electric mt-0.5 shrink-0" />
                  <div>
                    <p className="text-sm text-bone font-semibold">Use <code className="text-electric">livelyicons</code> with <code className="text-electric">&apos;use client&apos;</code> when:</p>
                    <p className="text-xs text-silver mt-1">You need hover effects, Motion animations, or interactive state changes.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-electric mt-0.5 shrink-0" />
                  <div>
                    <p className="text-sm text-bone font-semibold">Use <code className="text-electric">livelyicons/css</code> when:</p>
                    <p className="text-xs text-silver mt-1">You want RSC compatibility with CSS-based animations (spin, pulse, etc.).</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id="shadcn" className="mb-16 scroll-mt-24">
            <h2 className="font-display text-2xl font-bold text-bone mb-6 flex items-center gap-3">
              <span className="w-8 h-8 bg-graphite flex items-center justify-center text-sm text-electric">13</span>
              shadcn/ui Integration
            </h2>
            <p className="text-silver mb-6">
              LivelyIcons provides a shadcn-compatible registry that installs icons directly into your project following shadcn conventions.
              No npm package needed - components live in your codebase and are fully customizable.
            </p>
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.1</span>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-graphite">
                      <th className="text-left py-3 px-4 text-silver font-medium">Command</th>
                      <th className="text-left py-3 px-4 text-silver font-medium">What it installs</th>
                    </tr>
                  </thead>
                  <tbody className="text-ghost">
                    <tr className="border-b border-graphite/50">
                      <td className="py-3 px-4">
                        <code className="text-electric text-xs break-all">npx shadcn@latest add https://livelyicons.com/r/lively-essentials.json</code>
                      </td>
                      <td className="py-3 px-4 text-silver">Provider, hook, types + popular icons</td>
                    </tr>
                    <tr className="border-b border-graphite/50">
                      <td className="py-3 px-4">
                        <code className="text-electric text-xs break-all">npx shadcn@latest add https://livelyicons.com/r/heart-pulse.json</code>
                      </td>
                      <td className="py-3 px-4 text-silver">Individual icon component</td>
                    </tr>
                    <tr className="border-b border-graphite/50">
                      <td className="py-3 px-4">
                        <code className="text-electric text-xs break-all">npx shadcn@latest add https://livelyicons.com/r/lively-provider.json</code>
                      </td>
                      <td className="py-3 px-4 text-silver">Context provider only</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4">
                        <code className="text-electric text-xs break-all">npx shadcn@latest add https://livelyicons.com/r/lively-types.json</code>
                      </td>
                      <td className="py-3 px-4 text-silver">TypeScript types only</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.2</span>
              ...
              <CodeBlock code={shadcnInstallEssentialsCode} section="shadcn-essentials" />
            </div>

            {/* 13.3 Installing Individual Icons */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.3</span>
              ...
              <CodeBlock code={shadcnInstallIndividualCode} section="shadcn-individual" />
            </div>

            {/* 13.4 Basic Usage */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.4</span>
                Using Installed Icons
              </h3>
              <p className="text-sm text-silver mb-4">
                After installation, import icons from your local <code className="text-electric">@/components/icons</code> directory.
              </p>
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.5</span>
                Global Configuration with LivelyProvider
              </h3>
              <p className="text-sm text-silver mb-4">
                Wrap your app with <code className="text-electric">LivelyProvider</code> to set default values for all icons.
              </p>
              <CodeBlock code={shadcnProviderUsageCode} section="shadcn-provider" />
            </div>

            {/* 13.6 Styling with cn() and Tailwind */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.6</span>
                Styling with cn() and Tailwind
              </h3>
              <p className="text-sm text-silver mb-4">
                Icons are fully compatible with Tailwind CSS and the shadcn <code className="text-electric">cn()</code> utility for conditional styling.
              </p>
              <CodeBlock code={shadcnCustomStylingCode} section="shadcn-styling" />
            </div>

            {/* 13.7 File Structure */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.7</span>
                File Structure After Installation
              </h3>
              <p className="text-sm text-silver mb-4">
                Components are installed following shadcn conventions:
              </p>
              <CodeBlock code={shadcnFileStructureCode} section="shadcn-structure" />
            </div>

            {/* 13.8 Styling Conventions */}
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.8</span>
                Styling Conventions
              </h3>
              <div className="space-y-4">
                <div className="bg-carbon border border-graphite p-4">
                  <h4 className="text-sm font-semibold text-bone mb-2">CSS Variables</h4>
                  <p className="text-xs text-silver mb-3">
                    Icons support optional CSS variable customization:
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <code className="text-xs bg-graphite px-2 py-1 text-electric">--lively-icon-size</code>
                    <code className="text-xs bg-graphite px-2 py-1 text-electric">--lively-stroke-width</code>
                  </div>
                </div>
                <div className="bg-carbon border border-graphite p-4">
                  <h4 className="text-sm font-semibold text-bone mb-2">Component Pattern</h4>
                  <p className="text-xs text-silver">
                    All icons use React&apos;s <code className="text-electric">forwardRef</code> pattern, matching shadcn/ui components.
                    Refs are forwarded to the underlying SVG element.
                  </p>
                </div>
                <div className="bg-carbon border border-graphite p-4">
                  <h4 className="text-sm font-semibold text-bone mb-2">cn() Utility Required</h4>
                  <p className="text-xs text-silver">
                    Your project must have a <code className="text-electric">cn()</code> utility at <code className="text-electric">@/lib/utils</code>.
                    This is standard in shadcn/ui projects.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-10">
              <h3 className="font-display font-semibold text-bone mb-4 flex items-center gap-2">
                <span className="w-6 h-6 bg-electric/20 text-electric flex items-center justify-center text-xs">13.9</span>
                Available Icons
              </h3>
              <div className="bg-carbon border border-graphite p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-silver">icons available via registry</p>
                  </div>
                ...
                <p className="text-xs text-silver">
                  All icons from the LivelyIcons library are available through the shadcn registry.
                  Use the icon browser to find icons by name or category, then install them with the CLI.
                </p>
              </div>
            </div>
            ...
            <div className="bg-carbon border border-graphite p-6">
              <h4 className="font-display font-semibold text-bone mb-4">Requirements</h4>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-electric mt-0.5 shrink-0" />
                  <div>
                    <p className="text-sm text-bone font-semibold">Motion library</p>
                    <p className="text-xs text-silver mt-1">Run <code className="text-electric">npm install motion</code> or <code className="text-electric">pnpm add motion</code></p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-electric mt-0.5 shrink-0" />
                  <div>
                    <p className="text-sm text-bone font-semibold">cn() utility</p>
                    <p className="text-xs text-silver mt-1">Your project needs <code className="text-electric">@/lib/utils</code> with the <code className="text-electric">cn()</code> function (standard in shadcn/ui)</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Check size={16} className="text-electric mt-0.5 shrink-0" />
                  <div>
                    ...
                    <p className="text-xs text-silver mt-1">Icons use modern React features like <code className="text-electric">forwardRef</code></p>
                  </div>
                </div>
              </div>
            </div>
